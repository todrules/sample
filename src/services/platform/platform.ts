...
import { getCss, isTextInput } from './utils/utils';
...
export class Platform {
   ...
   */
  registerListener(ele: any, eventName: string, callback: { (ev?: UIEvent): void }, opts: EventListenerOptions,
