(function () {
  ...
  d.Class = function (a) {
    ...
    a.inherits ? (b.prototype = new a.inherits(
      d.inheriting), b.base = a.inherits.prototype, delete a.inherits) : (b.prototype.createEvents = function () {
  ...
  d.addChart = function (a) {
    window.requestAnimationFrame ? d.animationRequested || (d.animationRequested = !0, window.requestAnimationFrame(
      d.update)) : d.updateInt || (d.updateInt = setInterval(function () {
      d.update();
  ...
  d.removeChart = function (a) {
    ...
    0 === b.length && (d.requestAnimation && (window.cancelAnimationFrame(
      d.requestAnimation), d.animationRequested = !1), d.updateInt && (clearInterval(d.updateInt), d.updateInt = NaN));
  };
  d.isModern = !0;
  d.getIEVersion = function () {
    var a = 0, b, c;
    'Microsoft Internet Explorer' == navigator.appName && (b = navigator.userAgent, c = /MSIE ([0-9]{1,}[.0-9]{0,})/, null !== c.exec(
      b) && (a = parseFloat(RegExp.$1)));
    return a;
  };
  d.applyLang = function (a, b) {
    ...
    c && (c = c[ a ]) && (d.lang = c, b.langObj = c, c.monthNames && (b.dayNames = d.extend({},
      c.dayNames), b.shortDayNames = d.extend({}, c.shortDayNames), b.monthNames = d.extend({},
  ...
  d.isNN && (document.addEventListener('mousemove', d.handleMouseMove), document.addEventListener('mouseup',
    d.handleMouseUp, !0), window.addEventListener('load', d.handleLoad, !0));
  d.isIE && (document.attachEvent('onmousemove', d.handleMouseMove), document.attachEvent('onmouseup',
    d.handleMouseUp), window.attachEvent('onload', d.handleLoad));
  d.addWheelListeners = function () {
    d.wheelIsListened || (d.isNN && (window.addEventListener('DOMMouseScroll', d.handleWheel,
      !0), document.addEventListener('mousewheel', d.handleWheel, !0)), d.isIE && document.attachEvent('onmousewheel',
      d.handleWheel));
    d.wheelIsListened = !0;
  };
  d.clear = function () {
    ...
    d.isNN && (document.removeEventListener('mousemove', d.handleMouseMove, !0), document.removeEventListener('mouseup',
      d.handleMouseUp, !0), window.removeEventListener('load', d.handleLoad, !0), window.removeEventListener(
      'DOMMouseScroll', d.handleWheel, !0), document.removeEventListener('mousewheel', d.handleWheel, !0));
    d.isIE && (document.detachEvent('onmousemove', d.handleMouseMove), document.detachEvent('onmouseup',
      d.handleMouseUp), window.detachEvent('onload', d.handleLoad));
  };
  ...
  d.update = function () {
    ...
    if (a) {
      for (var c = a.length - 1; 0 <= c;
        c--) a[ c ].update && a[ c ].update(), b && (a[ c ].autoResize ? a[ c ].validateSize && a[ c ].validateSize() : a[ c ].premeasure && a[ c ].premeasure());
    }
...
(function () {
  ...
  d.getDecimals = function (a) {
    var b = 0;
    isNaN(a) || (a = String(a), -1 != a.indexOf('e-') ? b = Number(a.split('-')[ 1 ]) : -1 != a.indexOf(
      '.') && (b = a.split('.')[ 1 ].length));
    return b;
  };
  d.wordwrap = function (a, b, c, e) {
    ...
    for (a = (k = a.split(/\r\n|\n|\r/)).length; ++g < a; k[ g ] += h) {
      h = k[ g ];
      for (k[ g ] = ''; h.length > b;
        k[ g ] += d.trim(h.slice(0, f)) + ((h = h.slice(f)).length ? c : '')) f = 2 == e || (f = h.slice(0, b + 1)
        .match(/\S*(\s)?$/))[ 1 ] ? b : f.input.length - f[ 0 ].length || 1 == e && b || f.input.length + (f = h.slice(
        b).match(/^\S*/))[ 0 ].length;
      h = d.trim(h);
    }
    return k.join(c);
    ...
    if (a) {
      if ('_self' != b && b) {
        if ('_top' == b && window.top) {
          ...
          c ? c.src = a : (c = d.windows[ b ]) ? c.opener && !c.opener.closed ? c.location.href = a : d.windows[ b ] = window.open(
            a) : d.windows[ b ] = window.open(a);
        }
      } else {
  ...
  d.toCoordinate = function (a, b, c) {
    var e;
    void 0 !== a && (a = String(a), c && c < b && (b = c), e = Number(a), -1 != a.indexOf('!') && (e = b - Number(
      a.substr(1))), -1 != a.indexOf('%') && (e = b * Number(a.substr(0, a.length - 1)) / 100));
    return e;
  };
  ...
  d.formatDuration = function (a, b, c, e, g, f) {
    ...
    if (a >= h[ b ].contains) {
      ...
      'ss' == b ? (l = d.formatNumber(l, f), 1 == l.split(k)[ 0 ].length && (l = '0' + l)) : l = d.roundTo(l,
        f.precision);
    ...
    if (h[ g ].count > h[ b ].count) {
      for (a = h[ b ].count; a < h[ g ].count;
        a++) b = h[ b ].nextInterval, 'ss' == b || 'mm' == b || 'hh' == b ? c = '00' + e[ b ] + '' + c : 'DD' == b && (c = '0' + e[ b ] + '' + c);
    }
  ...
  d.formatNumber = function (a, b, c, e, g) {
    ...
    if (l) {
      ...
      for (n = l.length; 0 <= n; n -= 3) m = n != l.length ? 0 !== n ? l.substring(n - 3,
        n) + b + m : l.substring(n - 3, n) + m : l.substring(n - 3, n);
  ...
  d.addZeroes = function (a, b, c) {
    ...
    return a[ 1 ].length < c ? (a[ 1 ] += '0', d.addZeroes(a[ 0 ] + b + a[ 1 ], b,
      c)) : void 0 !== a[ 1 ] ? a[ 0 ] + b + a[ 1 ] : a[ 0 ];
  };
  ...
  d.formatValue = function (a, b, c, e, g, f, h, k) {
    if (b) {
      ...
      for (l = 0; l < c.length; l++) {
        var m = c[ l ], n = b[ m ];
        void 0 !== n && (n = f ? d.addPrefix(n, k, h, e) : d.formatNumber(n, e), a = a.replace(
          new RegExp('\\[\\[' + g + '' + m + '\\]\\]', 'g'), n));
      }
    }
    return a;
  ...
  d.addPrefix = function (a, b, c, e, g) {
    ...
    if (1 < a) {
      for (k = b.length - 1; -1 < k; k--) {
        if (a >= b[ k ].number && (l = a / b[ k ].number, m = Number(e.precision), 1 > m && (m = 1), c = d.roundTo(l,
            m), m = d.formatNumber(c, {
            precision: -1, decimalSeparator: e.decimalSeparator, thousandsSeparator: e.thousandsSeparator
          }), !g || l == c)) {
          f = h + '' + m + '' + b[ k ].prefix;
          break;
        }
      ...
      for (k = 0; k < c.length; k++) if (a <= c[ k ].number) {
        l = a / c[ k ].number;
  ...
  d.copyProperties = function (a, b) {
    for (var c in a) a.hasOwnProperty(
      c) && 'events' != c && void 0 !== a[ c ] && 'function' != typeof a[ c ] && 'cname' != c && (b[ c ] = a[ c ]);
  };
  d.processObject = function (a, b, c, e) {
    if (!1 === a instanceof b && (a = e ? d.extend(new b(c), a) : d.extend(a, new b(c), !0), a.listeners)) {
      for (var g in
        a.listeners) b = a.listeners[ g ], a.addListener(b.event, b.method);
    }
    return a;
  };
    ...
    if (a) {
      ...
      if (0 !== b) {
        if ('[object Array]' === Object.prototype.toString.call(a)) {
          ...
          try {
            for (c in a.theme = null, a) a[ c ] && ('object' == typeof a[ c ] && d.deleteObject(
              a[ c ], b - 1), 'function' != typeof a[ c ] && (a[ c ] = null));
          } catch (e) {
          }
        }
      }
  ...
  d.parseDefs = function (a, b) {
    for (var c in a) {
      ...
      if (0 < a[ c ].length && 'object' == e) {
        for (var g = 0; g < a[ c ].length; g++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(
          e), d.parseDefs(a[ c ][ g ], e);
      } else {
        'object' == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[ c ],
          e)) : b.setAttribute(c, a[ c ]);
      }
    }
  };
})();
  ...
  d.AxisBase = d.Class({
    construct: function (a) {
      ...
      this.periods = [
        ...
        { period: 'hh', count: 3 }, { period: 'hh', count: 6 }, { period: 'hh', count: 12 }, { period: 'DD', count: 1 },
        { period: 'DD', count: 2 }, { period: 'DD', count: 3 }, { period: 'DD', count: 4 }, { period: 'DD', count: 5 },
        { period: 'WW', count: 1 }, { period: 'MM', count: 1 }, { period: 'MM', count: 2 }, { period: 'MM', count: 3 },
      ...
      this.dateFormats = [
        { period: 'fff', format: 'NN:SS.QQQ' }, { period: 'ss', format: 'JJ:NN:SS' }, { period: 'mm', format: 'JJ:NN' },
      ...
      this.autoGridCount ? ('V' == this.orientation ? (a = this.height / this.minVerticalGap, 3 > a && (a = 3)) : a = this.width / this.minHorizontalGap, this.gridCountR = Math.max(
        a, 1)) : this.gridCountR = this.gridCount;
      ...
      for (var b = 10; 0 < b; b--) if (a / b == Math.round(a / b)) {
        return a / b;
      }
      ...
      if (0 < this.gridCountR) {
        for (B - 5 - k > this.autoRotateCount && !isNaN(
          this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
          p = q + y * (a + Math.floor((D - q) / y)) - C;
          'DD' == A && (p += 36E5);
          p = d.resetDateToMin(new Date(p), A, u, t).getTime();
          'MM' == A && (g = (p - l) / y, 1.5 <= (p - l) / y && (p = p - (g - 1) * y + d.getPeriodDuration('DD',
            3), p = d.resetDateToMin(new Date(p), A, 1).getTime(), C += y));
          ...
          f && this.markPeriodChange ? (f = this.dateFormatsObject[ this.nextPeriod[ h ] ], this.twoLineMode && (f = this.dateFormatsObject[ h ] + '\n' + f, f = d.fixBrakes(
            f)), l = !0) : f = this.dateFormatsObject[ h ];
          r || (l = !1);
          ...
          m = l = p;
          if (!isNaN(w)) {
            for (g = 1; g < u; g += w) this.gridAlpha = this.minorGridAlpha, f = p + x * g, f = d.resetDateToMin(
              new Date(f), A, w, t)
              .getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0,
              void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
          }
          this.gridAlpha = z;
        }
      }
      ...
      return 'DD' == a && 'hh' != g && c - b < d.getPeriodDuration(a, e) - d.getPeriodDuration('hh',
        1) ? !1 : c != b ? !0 : !1;
      ...
      if (this.balloon && void 0 !== e && this.balloon.enabled) {
        if (this.balloonTextFunction) {
          ...
          this.balloonText ? e = this.formatBalloonText(this.balloonText, f, c) : isNaN(e) || (e = this.formatValue(e,
            c));
        }
...
(function () {
  ...
  d.ValueAxis = d.Class({
    inherits: d.AxisBase, construct: function (a) {
      ...
      var a = this.chart;
      'xy' != a.type && (this.stackGraphs('smoothedLine'), this.stackGraphs('line'), this.stackGraphs(
        'column'), this.stackGraphs('step'));
      this.recalculateToPercents && this.recalculate();
      if (this.synchronizationMultiplier && this.synchronizeWith) {
        d.isString(this.synchronizeWith) && (this.synchronizeWith = a.getValueAxisById(
          this.synchronizeWith)), this.synchronizeWith && (this.synchronizeWithAxis(
          this.synchronizeWith), this.foundGraphs = !0);
      } else if (this.foundGraphs = !1, this.getMinMax(), 0 === this.start && this.end == this.data.length - 1 && isNaN(
          this.minZoom) && isNaN(this.maxZoom) || isNaN(this.fullMin) && isNaN(this.fullMax)) {
        this.fullMin = this.min, this.fullMax = this.max, 'date' != this.type && this.strictMinMax && (isNaN(
          this.minimum) || (this.fullMin = this.minimum), isNaN(
          this.maximum) || (this.fullMax = this.maximum)), this.logarithmic && (this.fullMin = this.logMin, 0 === this.fullMin && (this.fullMin = this.treatZeroAs)), 'date' == this.type && (this.minimumDate || (this.fullMin = this.minRR), this.maximumDate || (this.fullMax = this.maxRR), this.strictMinMax && (this.minimumDate && (this.fullMin = this.minimumDate.getTime()), this.maximumDate && (this.fullMax = this.maximumDate.getTime())));
      }
    }, draw: function () {
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) {
        ...
        if (this.strictMinMax && (isNaN(this.minimum) || (this.min = this.minimum), isNaN(
            this.maximum) || (this.max = this.maximum), this.min == this.max)) {
          return;
        }
        ...
        if (this.logarithmic) {
          ...
          this.relativeStart = d.roundTo(d.fitToBounds((this.min - this.fullMin) / (this.fullMax - this.fullMin), 0, 1),
            5), this.relativeEnd = d.roundTo(
            d.fitToBounds((this.max - this.fullMin) / (this.fullMax - this.fullMin), 0, 1), 5);
        }
        var r = Math.round((this.maxCalc - this.minCalc) / this.step) + 1, z;
        !0 === g ? (z = Math.log(this.max) * Math.LOG10E - Math.log(
          this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / z, z > this.logGridLimit && (r = Math.ceil(Math.log(
          this.max) * Math.LOG10E) + 1, t = Math.round(Math.log(
          this.minReal) * Math.LOG10E), r > this.gridCountR && (p = Math.ceil(r / this.gridCountR)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
        var x = 0;
        ...
        w = this.precision;
        isNaN(w) || (x = w);
        isNaN(this.maxZoom) && (this.max = d.roundTo(this.max, this.maxDecCount), this.min = d.roundTo(this.min,
          this.maxDecCount));
        h = {};
        h.precision = x;
        ...
        if (this.autoGridCount || 0 !== this.gridCount) {
          if ('date' == c) {
            ...
            for (r >= this.autoRotateCount && !isNaN(
              this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), c = this.minCalc, g && (r++, c = this.maxCalc - r * x), this.gridCountReal = r, h = this.startCount = t;
              h < r; h += p) if (t = x * h + c, t = d.roundTo(
                t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t) {
              if (isNaN(w) || Number(d.toFixed(t, w)) == t) {
                ...
                if (t == this.baseValue && 'radar' != a.type) {
                  ...
                  'H' == this.orientation ? 0 <= f && f <= I + 1 && (D = [ f, f, f + k ], C = [
                    H, 0, l
                  ]) : 0 <= f && f <= H + 1 && (D = [ 0, I, I + k ], C = [ f, f, f + l ]);
                  D && (f = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(
                    this.zeroGridAlpha) || (f = this.zeroGridAlpha), f = d.line(a.container, D, C, this.gridColor, f, 1,
                    this.dashLength), f.translate(this.x, this.y), this.grid0 = f, a.axesSet.push(
                    f), f.toBack(), d.setCN(a, f, this.bcn + 'zero-grid-' + this.id), d.setCN(a,
                    f, this.bcn + 'zero-grid'));
                }
                if (!isNaN(y) && 0 < A && h < r - 1) {
                  f = x / y;
                  g && (y = x * (h + p) + this.minCalc, y = d.roundTo(
                    y, this.maxDecCount + 1), z > this.logGridLimit && (y = Math.pow(
                    10, h + p)), f = 9, y = (y - t) / f);
                  I = this.gridAlpha;
        ...
        if (0 < B) {
          D = this.fillAlpha;
          for (h = this.fillAlpha = 0; h < B; h++) C = z[ h ], k = NaN, y = C.above, isNaN(
            C.toValue) || (k = this.getCoordinate(C.toValue), u = new this.axisItemRenderer(this, k, '', !0, NaN, NaN,
            C), this.pushAxisItem(u, y)), l = NaN, isNaN(C.value) || (l = this.getCoordinate(
            C.value), u = new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(u,
            y)), isNaN(k) && (l -= 3, k = l + 3), u && (m = u.label) && this.addEventListeners(m,
            C), isNaN(k - l) || 0 > l && 0 > k || (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k,
            y), y = k.graphics(), C.graphics = y, this.addEventListeners(y, C));
          this.fillAlpha = D;
        }
        u = this.baseValue;
      ...
      this.maximumDate && (this.maximumDate instanceof Date || (this.maximumDate = d.getDate(this.maximumDate,
        this.chart.dataDateFormat, 'fff')), this.max = this.maximumDate.getTime());
    }, formatValue: function (a, b, c) {
      var e = this.exponential, g = this.logarithmic, f = this.numberFormatter, h = this.chart;
      if (f) {
        return !0 === this.logarithmic && (e = -1 != String(a).indexOf(
          'e') ? !0 : !1), this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e ? (c = -1 == String(
          a)
          .indexOf('e') ? a.toExponential(15) : String(a), e = c.split('e'), c = Number(e[ 0 ]), e = Number(
          e[ 1 ]), c = d.roundTo(c, 14), b || isNaN(this.precision) || (c = d.roundTo(c,
          this.precision)), 10 == c && (c = 1, e += 1), c = c + 'e' + e, 0 === a && (c = '0'), 1 == a && (c = '1')) : (g && (e = String(
          a).split('.'), e[ 1 ] ? (f.precision = e[ 1 ].length, 0 > c && (f.precision = Math.abs(
          c)), b && 1 < a && (f.precision = 0), b || isNaN(
          this.precision) || (f.precision = this.precision)) : f.precision = -1), c = this.usePrefixes ? d.addPrefix(a,
          h.prefixesOfBigNumbers, h.prefixesOfSmallNumbers, f, !b) : d.formatNumber(a, f,
          f.precision)), this.duration && (b && (f.precision = 0), c = d.formatDuration(a, this.duration, '',
          this.durationUnits, this.maxInterval, f)), 'date' == this.type && (c = d.formatDate(new Date(a),
          this.currentDateFormat,
          h)), this.recalculateToPercents ? c += '%' : (b = this.unit) && (c = 'left' == this.unitPosition ? b + c : c + b), this.labelFunction && (c = 'date' == this.type ? this.labelFunction(
          c, new Date(a), this).toString() : this.labelFunction(a, c, this).toString()), c;
      }
      ...
      if (r && ('regular' == b || '100%' == b)) {
        for (q = 0; q < k.length;
          q++) n = k[ q ], n.stackGraph = null, n.hidden || (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (l && (n.stackGraph = l), l = n));
      }
      n = this.start - 10;
      l = this.end + 10;
      ...
      for (p = n; p <= l; p++) {
        var w = 0;
        for (q = 0; q < k.length; q++) if (n = k[ q ], n.hidden) {
          ...
          if (m = this.data[ p ].axes[ this.id ].graphs[ n.id ], h = m.values.value, isNaN(h)) {
            ...
            'regular' == b && (r && (isNaN(
              c[ p ]) ? (c[ p ] = h, m.values.close = h, m.values.open = this.baseValue) : (isNaN(
              h) ? m.values.close = c[ p ] : m.values.close = h + c[ p ], m.values.open = c[ p ], c[ p ] = m.values.close)), 'column' == a && (n.newStack && (g[ p ] = NaN, e[ p ] = NaN), m.values.close = h, 0 > h ? (m.values.close = h, isNaN(
              e[ p ]) ? m.values.open = t : (m.values.close += e[ p ], m.values.open = e[ p ]), e[ p ] = m.values.close) : (m.values.close = h, isNaN(
              g[ p ]) ? m.values.open = t : (m.values.close += g[ p ], m.values.open = g[ p ]), g[ p ] = m.values.close)));
          }
        }
      }
      for (p = this.start; p <= this.end; p++) for (q = 0; q < k.length;
        q++) (n = k[ q ], n.hidden) ? n.newStack && (g[ p ] = NaN, e[ p ] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (m = this.data[ p ].axes[ this.id ].graphs[ n.id ], h = m.values.value, isNaN(
          h) || (c = h / f[ p ] * 100, m.values.percents = c, m.values.total = f[ p ], n.newStack && (g[ p ] = NaN, e[ p ] = NaN), '100%' == b && (isNaN(
          e[ p ]) && (e[ p ] = 0), isNaN(g[ p ]) && (g[ p ] = 0), 0 > c ? (m.values.close = d.fitToBounds(c + e[ p ],
          -100, 100), m.values.open = e[ p ], e[ p ] = m.values.close) : (m.values.close = d.fitToBounds(c + g[ p ],
          -100, 100), m.values.open = g[ p ], g[ p ] = m.values.close)))));
      ...
      for (c = 0; c < b.length; c++) {
        ...
        if (e.valueAxis == this) {
          ...
          if (m = a.recalculateFromDate) {
            m = d.getDate(m, a.dataDateFormat, 'fff'), h = a.getClosestIndex(a.chartData, 'time', m.getTime(), !0, 0,
              a.chartData.length), k = a.chartData.length - 1;
          }
          for (m = h;
            m <= k && (h = this.data[ m ].axes[ this.id ].graphs[ e.id ], f = h.values[ g ], e.recalculateValue && (f = h.dataContext[ e.valueField + e.recalculateValue ]), isNaN(
              f)); m++) ;
          this.recBaseValue = f;
          for (g = l; g <= k; g++) {
      ...
      if (this.includeGuidesInMinMax && 0 < a) {
        for (b = 0; b < a;
          b++) c = this.guides[ b ], c.toValue < this.min && (this.min = c.toValue), c.value < this.min && (this.min = c.value), c.toValue > this.max && (this.max = c.toValue), c.value > this.max && (this.max = c.value);
      }
      ...
      b = this.max;
      c = this.max - this.min;
      e = 0 === c ? Math.pow(10, Math.floor(Math.log(Math.abs(this.max)) * Math.LOG10E)) / 10 : Math.pow(10,
        Math.floor(Math.log(Math.abs(c)) * Math.LOG10E)) / 10;
      ...
      1 > c ? (this.maxDecCount = Math.abs(Math.log(Math.abs(c)) * Math.LOG10E), this.maxDecCount = Math.round(
        this.maxDecCount), this.step = d.roundTo(this.step, this.maxDecCount + 1)) : this.maxDecCount = 0;
      ...
      this.logarithmic && (2 < Math.log(b) * Math.LOG10E - Math.log(
        a) * Math.LOG10E ? (this.minReal = this.min = Math.pow(10,
        Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.maxReal = this.max = Math.pow(10,
        Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))) : (a = Math.pow(10,
        Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, Math.pow(10,
        ...
        for (h in f) if (f.hasOwnProperty(h)) {
          ...
          if (k.includeInMinMax && (!k.hidden || this.includeHidden)) {
            ...
            if (this.minMaxField) {
              ...
              for (var m in
                k) k.hasOwnProperty(
                m) && 'percents' != m && 'total' != m && 'error' != m && (l = k[ m ], l < c && (c = l), l > e && (e = l));
            }
          }
        }
      }
      ...
      this.logarithmic && (isNaN(this.minimum) || (e = this.minimum), isNaN(
        this.maximum) || (d = this.maximum), d = Math.log(d) * Math.LOG10E - Math.log(e) * Math.LOG10E, f = Math.pow(
        10, d * a + Math.log(e) * Math.LOG10E), h = Math.pow(10, d * b + Math.log(e) * Math.LOG10E));
      ...
      if (this.minZoom != a || this.maxZoom != b) {
        return this.minZoom = a, this.maxZoom = b, e = { type: 'axisZoomed' }, e.chart = this.chart, e.valueAxis = this, e.startValue = a, e.endValue = b, e.relativeStart = this.relativeStart, e.relativeEnd = this.relativeEnd, this.prevStartValue == a && this.prevEndValue == b || this.fire(
          e), this.prevStartValue = a, this.prevEndValue = b, c || (a = {}, d.copyProperties(e,
          a), a.type = 'axisIntZoomed', this.fire(
          a)), 0 === this.relativeStart && 1 == this.relativeEnd && (this.maxZoom = this.minZoom = NaN), !0;
      }
      ...
      return !0 === this.logarithmic ? Math.pow(
        10, (d ? !0 === e ? (b - a) / c : a / c : !0 === e ? a / c : (b - a) / c) + Math.log(
        h) * Math.LOG10E) : !0 === e ? d ? f - (a - b) / c : a / c + f : d ? a / c + f : f - (a - b) / c;
    }, getCoordinate: function (a, b) {
      if (isNaN(a)) {
        return NaN;
      }
      var c = this.rotate, e = this.reversed, d = this.axisWidth, f = this.stepWidth, h = this.min, k = this.minReal;
      !0 === this.logarithmic ? (0 === a && (a = this.treatZeroAs), h = Math.log(a) * Math.LOG10E - Math.log(
        k) * Math.LOG10E, c = c ? !0 === e ? d - f * h : f * h : !0 === e ? f * h : d - f * h) : c = !0 === e ? c ? d - f * (a - h) : f * (a - h) : c ? f * (a - h) : d - f * (a - h);
      ...
      if (this.synchronizeWith) {
        ...
        e && (this.min = b * e, this.max = c * e, this.step = a * e, b = Math.abs(Math.log(Math.abs(Math.pow(10,
          Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)))) * Math.LOG10E), this.maxDecCount = b = Math.round(
          b), this.draw());
      }
    }
  });
...
(function () {
  ...
  d.RecAxis = d.Class({
    construct: function (a) {
      var b = a.chart, c = a.axisThickness, e = a.axisColor, g = a.axisAlpha, f = a.offset, h = a.dx, k = a.dy, l = a.x,
        m = a.y, n = a.height, q = a.width, p = b.container;
      'H' == a.orientation ? (e = d.line(p, [ 0, q ], [ 0, 0 ], e, g,
        c), this.axisWidth = a.width, 'bottom' == a.position ? (k = c / 2 + f + n + m - 1, c = l) : (k = -c / 2 - f + m + k, c = h + l)) : (this.axisWidth = a.height, 'right' == a.position ? (e = d.line(
        p, [ 0, 0, -h ], [ 0, n, n - k ], e, g, c), k = m + k, c = c / 2 + f + h + q + l - 1) : (e = d.line(p, [ 0, 0 ],
        [ 0, n ], e, g, c), k = m, c = -c / 2 - f + l));
      e.translate(c, k);
      c = b.container.set();
      c.push(e);
      b.axesSet.push(c);
...
(function () {
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
      ...
      this.set = x;
      var u = a.axisThickness, A = a.axisColor, y = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness,
        I = a.gridColor, H = a.dashLength, Q = a.fillColor, M = a.fillAlpha, P = a.labelsEnabled;
      n = a.labelRotationR;
      var ia = a.counter, J = a.inside, aa = a.labelOffset, ma = a.dx, na = a.dy, Pa = a.orientation, Z = a.position,
        da = a.previousCoord, X = a.height, xa = a.width, ea = a.offset, fa, Ba;
      h ? (void 0 !== h.id && (q = p.classNamePrefix + '-guide-' + h.id), P = !0, isNaN(
        h.tickLength) || (B = h.tickLength), void 0 != h.lineColor && (I = h.lineColor), void 0 != h.color && (w = h.color), isNaN(
        h.lineAlpha) || (D = h.lineAlpha), isNaN(h.dashLength) || (H = h.dashLength), isNaN(
        h.lineThickness) || (C = h.lineThickness), !0 === h.inside && (J = !0, 0 < ea && (ea = 0)), isNaN(
        h.labelRotation) || (n = h.labelRotation), isNaN(
        h.fontSize) || (r = h.fontSize), h.position && (Z = h.position), void 0 !== h.boldLabel && (k = h.boldLabel), isNaN(
        h.labelOffset) || (aa = h.labelOffset)) : '' === c && (B = 0);
      ...
      'V' == Pa && (n = 0);
      var ca;
      P && '' !== c && (ca = a.autoWrap && 0 === n ? d.wrappedText(z, c, w, t, r, ga, k, Math.abs(g), 0) : d.text(z, c,
        w, t, r, ga, k), ga = ca.getBBox(), ha = ga.width, Qa = ga.height);
      if ('H' == Pa) {
        if (0 <= b && b <= xa + 1 && (0 < B && 0 < y && b + l <= xa + 1 && (fa = d.line(z, [ b + l, b + l ], [ 0, B ],
            A, y, C), x.push(fa)), 0 < D && (Ba = d.line(z, [ b, b + ma, b + ma ], [ X, X + na, na ], I, D, C,
            H), x.push(
            Ba))), v = 0, G = b, h && 90 == n && J && (G -= r), !1 === e ? (ga = 'start', v = 'bottom' == Z ? J ? v + B : v - B : J ? v - B : v + B, G += 3, 0 < g && (G += g / 2 - 3, ga = 'middle'), 0 < n && (ga = 'middle')) : ga = 'middle', 1 == ia && 0 < M && !h && !m && da < xa && (e = d.fitToBounds(
            b, 0, xa), da = d.fitToBounds(da, 0, xa), Y = e - da, 0 < Y && (Da = d.rect(z, Y, a.height, Q,
            M), Da.translate(e - Y + ma, na), x.push(
            Da))), 'bottom' == Z ? (v += X + r / 2 + ea, J ? (0 < n ? (v = X - ha / 2 * Math.sin(
            V) - B - 3, a.centerRotatedLabels || (G += ha / 2 * Math.cos(V) - 4 + 2)) : 0 > n ? (v = X + ha * Math.sin(
            V) - B - 3 + 2, G += -ha * Math.cos(V) - Qa * Math.sin(
            V) - 4) : v -= B + r + 3 + 3, v -= aa) : (0 < n ? (v = X + ha / 2 * Math.sin(
            V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(
            V))) : 0 > n ? (v = X + B + 3 - ha / 2 * Math.sin(V) + 2, G += ha / 2 * Math.cos(
            V)) : v += B + u + 3 + 3, v += aa)) : (v += na + r / 2 - ea, G += ma, J ? (0 < n ? (v = ha / 2 * Math.sin(
            V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(
            V))) : v += B + 3, v += aa) : (0 < n ? (v = -(ha / 2) * Math.sin(
            V) - B - 6, a.centerRotatedLabels || (G += ha / 2 * Math.cos(
            V))) : v -= B + r + 3 + u + 3, v -= aa)), 'bottom' == Z ? Y = (J ? X - B - 1 : X + u - 1) + ea : (oa = ma, Y = (J ? na : na - B - u + 1) - ea), f && (G += f), r = G, 0 < n && (r += ha / 2 * Math.cos(
            V)), ca && (f = 0, J && (f = ha / 2 * Math.cos(V)), r + f > xa + 2 || 0 > r)) {
          ca.remove(), ca = null;
        }
      } else {
        0 <= b && b <= X + 1 && (0 < B && 0 < y && b + l <= X + 1 && (fa = d.line(z, [ 0, B + 1 ], [ b + l, b + l ], A,
          y, C), x.push(fa)), 0 < D && (Ba = d.line(z, [ 0, ma, xa + ma ], [ b, b + na, b + na ], I, D, C, H), x.push(
          Ba)));
        ga = 'end';
        ...
        v = b - Qa / 2 + 2;
        1 == ia && 0 < M && !h && !m && (e = d.fitToBounds(b, 0, X), da = d.fitToBounds(da, 0,
          X), V = e - da, Da = d.polygon(z, [ 0, a.width, a.width, 0 ], [ 0, 0, V, V ], Q, M), Da.translate(
          ma, e - V + na), x.push(Da));
        v += r / 2;
      ...
      ca && (ca.attr({ 'text-anchor': ga }), ca.translate(G, v, NaN, !0), 0 !== n && ca.rotate(-n,
        a.chart.backgroundColor), a.allLabels.push(ca), this.label = ca, d.setCN(p, ca, a.bcn + 'label'), d.setCN(p, ca,
        q, !0), h && d.setCN(p, ca, 'guide'));
...
(function () {
  ...
  d.RecFill = d.Class({
    construct: function (a, b, c, e) {
      ...
      'V' == h ? (b = d.fitToBounds(b, 0, a.height), c = d.fitToBounds(c, 0, a.height)) : (b = d.fitToBounds(b, 0,
        a.width), c = d.fitToBounds(c, 0, a.width));
      c -= b;
      isNaN(c) && (c = 4, k = 2, m = 0);
      0 > c && 'object' == typeof n && (n = n.join(',').split(',').reverse());
      'V' == h ? (h = d.rect(l, a.width, c, n, m), h.translate(g, b - k + f)) : (h = d.rect(l, c, a.height, n,
        m), h.translate(b - k + g, f));
...
(function () {
  ...
  d.AmChart = d.Class({
    construct: function (a) {
      ...
      this.version = '3.21.9';
      d.addChart(this);
      this.createEvents('buildStarted', 'dataUpdated', 'init', 'rendered', 'drawn', 'failed', 'resized',
        'animationFinished');
      ...
      this.prefixesOfBigNumbers = [
        { number: 1E3, prefix: 'k' }, { number: 1E6, prefix: 'M' }, { number: 1E9, prefix: 'G' },
        { number: 1E12, prefix: 'T' }, { number: 1E15, prefix: 'P' }, { number: 1E18, prefix: 'E' },
        { number: 1E21, prefix: 'Z' }, { number: 1E24, prefix: 'Y' }
      ];
      this.prefixesOfSmallNumbers = [
        { number: 1E-24, prefix: 'y' }, { number: 1E-21, prefix: 'z' }, { number: 1E-18, prefix: 'a' },
      ...
      if (d.ifArray(b)) {
        ...
        for (e = 0; e < b.length; e++) {
          ...
          if (!1 !== g.enabled) {
            ...
            f = d.wrappedText(this.container, g.text, f, this.fontFamily, h, 'middle',
              l, this.realWidth - 35 - this.marginRight - k);
      ...
      void 0 === this.pathToImages && (this.pathToImages = this.path + 'assets/charts/images/');
      this.initHC || (d.callInitHandler(this), this.initHC = !0);
      d.applyLang(this.language, this);
      var a = this.numberFormatter;
      a && (isNaN(
        a.precision) || (this.precision = a.precision), void 0 !== a.thousandsSeparator && (this.thousandsSeparator = a.thousandsSeparator), void 0 !== a.decimalSeparator && (this.decimalSeparator = a.decimalSeparator));
      (a = this.percentFormatter) && !isNaN(a.precision) && (this.percentPrecision = a.precision);
      this.nf = {
        precision: this.precision, thousandsSeparator: this.thousandsSeparator, decimalSeparator: this.decimalSeparator
      };
      this.pf = {
      ...
      this.destroy();
      (a = this.container) ? (a.container.innerHTML = '', a.width = this.realWidth, a.height = this.realHeight, a.addDefs(
        this), this.chartDiv.appendChild(a.container)) : a = new d.AmDraw(this.chartDiv, this.realWidth,
      ...
      a.chart = this;
      d.VML || d.SVG ? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness = this.handDrawThickness, d.remove(
        this.set), this.set = a.set(), d.remove(this.gridSet), this.gridSet = a.set(), d.remove(
        this.cursorLineSet), this.cursorLineSet = a.set(), d.remove(
        this.graphsBehindSet), this.graphsBehindSet = a.set(), d.remove(
        this.bulletBehindSet), this.bulletBehindSet = a.set(), d.remove(
        this.columnSet), this.columnSet = a.set(), d.remove(this.graphsSet), this.graphsSet = a.set(), d.remove(
        this.trendLinesSet), this.trendLinesSet = a.set(), d.remove(this.axesSet), this.axesSet = a.set(), d.remove(
        this.cursorSet), this.cursorSet = a.set(), d.remove(this.scrollbarsSet), this.scrollbarsSet = a.set(), d.remove(
        this.bulletSet), this.bulletSet = a.set(), d.remove(this.freeLabelsSet), this.freeLabelsSet = a.set(), d.remove(
        this.axesLabelsSet), this.axesLabelsSet = a.set(), d.remove(
        this.balloonsSet), this.balloonsSet = a.set(), d.remove(
        this.plotBalloonsSet), this.plotBalloonsSet = a.set(), d.remove(
        this.zoomButtonSet), this.zoomButtonSet = a.set(), d.remove(this.zbSet), this.zbSet = null, d.remove(
        this.linkSet), this.linkSet = a.set()) : this.fire({ type: 'failed', chart: this });
    }, premeasure: function () {
      var a = this.div;
      if (a) {
        try {
      ...
      if (a) {
        ...
        (c != this.previousWidth || e != this.previousHeight) && 0 < a && 0 < f && (b.style.width = a + 'px', b.style.height = f + 'px', b.style.padding = 0, g && g.setSize(
          a, f), this.balloon = d.processObject(this.balloon, d.AmBalloon, this.theme));
      ...
      if (this.autoTransform && window.getComputedStyle && a) {
        if (a.style) {
          ...
          if (b && (b = b.getPropertyValue('-webkit-transform') || b.getPropertyValue(
              '-moz-transform') || b.getPropertyValue('-ms-transform') || b.getPropertyValue(
              '-o-transform') || b.getPropertyValue('transform')) && 'none' !== b) {
      ...
      a = {
        text: a, size: b, color: c, alpha: e, bold: d, enabled: !0
      };
      this.titles.push(a);
      return a;
      ...
      }, document.addEventListener('touchstart', a.docfn1, !0), document.addEventListener('touchend', a.docfn2,
      ...
      this.skipEvents || (this.dispatchDataUpdated && (this.dispatchDataUpdated = !1, this.fire(
        { type: 'dataUpdated', chart: this })), this.chartCreated || (this.chartCreated = !0, this.fire(
        { type: 'init', chart: this })), this.chartRendered || (this.fire(
        { type: 'rendered', chart: this }), this.chartRendered = !0), this.fire({ type: 'drawn', chart: this }));
      this.skipEvents = !1;
      ...
      this.handleMouseMove();
      var f = this.balloon;
      f.enabled && (f.followCursor(!1), f.changeColor(b), !c || f.fixedPosition ? (f.setPosition(e, d), isNaN(
        e) || isNaN(d) ? f.followCursor(!0) : f.followCursor(!1)) : f.followCursor(!0), a && f.showBalloon(a));
      ...
      a && (a.touches && this.tapToActivate && !this.tapped || !this.panRequired) || (this.handleMouseMove(
        a), this.handleMouseDown(a));
      ...
      if (this.animations) {
        for (a = this.animations.length - 1; 0 <= a; a--) {
          ...
          if (e <= c) {
            ...
            0 === k ? (this.animations.splice(a, 1), g.node.style[ f ] = Number(
              b.to) + b.suffix) : g.node.style[ f ] = c + b.suffix;
          } else {
  ...
  d.AmGraph = d.Class({
    construct: function (a) {
      ...
      this.createEvents('rollOverGraphItem', 'rollOutGraphItem', 'clickGraphItem', 'doubleClickGraphItem',
        'rightClickGraphItem', 'clickGraph', 'rollOverGraph', 'rollOutGraph');
      this.type = 'line';
      this.stackable = !0;
      this.columnCount = 1;
      this.columnIndex = 0;
      ...
      if (a.drawGraphs) {
        isNaN(
          this.precision) || (this.numberFormatter ? this.numberFormatter.precision = this.precision : this.numberFormatter = {
          precision: this.precision, decimalSeparator: a.decimalSeparator, thousandsSeparator: a.thousandsSeparator
        });
        var c = a.container;
        this.container = c;
        this.destroy();
        ...
        this.behindColumns ? (a.graphsBehindSet.push(e), a.bulletBehindSet.push(g)) : (a.graphsSet.push(
          e), a.bulletSet.push(g));
        ...
        d.ifArray(
          this.data) && (a = !1, 'xy' == b ? this.xAxis.axisCreated && this.yAxis.axisCreated && (a = !0) : this.valueAxis.axisCreated && (a = !0), !this.hidden && a && this.createGraph());
        e.push(c);
      }
      ...
      if (!isNaN(a.valueAxis.min) && !isNaN(a.valueAxis.max)) {
        switch (c) {
          case'serial':
            a.categoryAxis && (a.createSerialGraph(), 'candlestick' == a.type && 1 > a.valueAxis.minMaxMultiplier && a.positiveClip(
              a.set));
            break;
          case'radar':
            a.createRadarGraph();
      ...
      for (d = this.start; d <= this.end; d++) {
        ...
        if (!isNaN(k) && !isNaN(l) && (a.push(h), b.push(m), f.x = h, f.y = m, k = this.createBullet(f, h, m,
            d), l = this.labelText)) {
      ...
      for (m = this.start; m <= this.end; m++) {
        ...
        if (isNaN(q)) {
          ...
          var t = this.valueAxis.getCoordinate(q, this.noRounding) - this.height, t = t * this.valueAxis.rMultiplier,
          ...
          c.push(t);
          if (!isNaN(p)) {
            var w = this.valueAxis.getCoordinate(p, this.noRounding) - this.height, w = w * this.valueAxis.rMultiplier,
              z = w * Math.sin(r / 180 * Math.PI), r = w * Math.cos(r / 180 * Math.PI);
            e.push(z);
            d.push(r);
            isNaN(k) && (k = z);
            isNaN(l) && (l = r);
          ...
          n.y = t;
          if (z = this.labelText) {
            z = this.createLabel(n, z), w = 0, r && (w = r.size), this.positionLabel(n, q, t, z, w);
          }
          isNaN(f) && (f = q);
          isNaN(h) && (h = t);
        }
      ...
      var a = this.chart, b = this.id, c = this.index, e = this.data, g = this.chart.container, f = this.valueAxis,
        h = this.type, k = this.columnWidthReal, l = this.showBulletsAt;
      ...
      var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate,
        r = this.columnCount, w = d.toCoordinate(this.cornerRadiusTop, k / 2), z = this.connect, x = [], u = [], A, y,
        B, D, C = this.chart.graphs.length, I, H = this.dx / this.tcc, Q = this.dy / this.tcc, M = f.stackType,
        P = this.start, ia = this.end, J = this.scrollbar, aa = 'graph-column-';
      J && (aa = 'scrollbar-graph-column-');
      var ma = this.categoryAxis, na = this.baseCoord, Pa = this.negativeBase, Z = this.columnIndex,
        da = this.lineThickness, X = this.lineAlpha, xa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba,
        ga = this.getGradRotation(), V = this.chart.columnSpacing, Y = ma.cellWidth, Da = (Y * k - r) / r;
      V > Da && (V = Da);
      var G, v, oa, ha = q, Qa = n, ca = 0, tb = 0, ub = 0, vb = 0, lb = 0, mb = 0, wb = this.fillColorsR,
        Ra = this.negativeFillColors, Ja = this.negativeLineColor, bb = this.fillAlphas, cb = this.negativeFillAlphas;
      ...
      if ('line' == h || 'step' == h || 'smoothedLine' == h) {
        if (0 < P) {
          for (L = P - 1; -1 < L; L--) if (G = e[ L ], v = G.axes[ f.id ].graphs[ b ], oa = v.values.value, !isNaN(
              oa)) {
            P = L;
            break;
          }
          if (this.lineColorField) {
            for (L = P; -1 < L; L--) if (G = e[ L ], v = G.axes[ f.id ].graphs[ b ], v.lineColor) {
          ...
          if (this.fillColorsField) {
            for (L = P; -1 < L; L--) if (G = e[ L ], v = G.axes[ f.id ].graphs[ b ], v.fillColors) {
              this.fillColorsSwitched = v.fillColors;
              break;
            }
          }
          if (this.dashLengthField) {
            for (L = P; -1 < L; L--) if (G = e[ L ], v = G.axes[ f.id ].graphs[ b ], !isNaN(v.dashLength)) {
        ...
        if (ia < e.length - 1) {
          for (L = ia + 1; L < e.length;
            L++) if (G = e[ L ], v = G.axes[ f.id ].graphs[ b ], oa = v.values.value, !isNaN(oa)) {
            ia = L;
            break;
          }
        }
      ...
      for (L = P; L <= ia; L++) {
        ...
        if (m && void 0 == this.openField) {
          for (var yb = L + 1;
            yb < e.length && (!e[ yb ] || !(fb = e[ L + 1 ].axes[ f.id ].graphs[ b ]) || !fb.values || (Ta = fb.values.value, isNaN(
              Ta))); yb++) ;
        }
        var S, R, K, ba, ja = NaN, E = NaN, F = NaN, O = NaN, N = NaN, qa = NaN, ra = NaN, sa = NaN, ta = NaN, ya = NaN,
          Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ua = NaN, va = void 0, Na = wb, Wa = bb, Ha = xa,
          Ca, za, Bb = this.proCandlesticks, pb = this.topRadius, Fa = q - 1, pa = n - 1, gb = this.pattern;
        ...
        if (Ia) {
          ...
          m && (void 0 == this.openField ? fb && (fb.isNegative = Ta < W ? !0 : !1, isNaN(
            Ta) && (v.isNegative = !Sa)) : v.isNegative = Ta > W ? !0 : !1);
          if (!J) {
          ...
          'start' == this.pointPosition && (ja -= Y / 2 + Math.floor(Xa * Y / 2), wa = 0, Ga = Math.floor(
            Y) + Math.floor(Xa * Y));
          'end' == this.pointPosition && (ja += Y / 2 + Math.floor(Xa * Y / 2), wa = Math.floor(
            Y) + Math.floor(Xa * Y), Ga = 0);
          if (Ob) {
          ...
          -1E5 > ja && (ja = -1E5);
          ja > n + 1E5 && (ja = n + 1E5);
          t ? (E = F, O = N, N = F = ja, isNaN(
            ua) && !this.fillToGraph && (O = na), qa = ra, sa = ta) : (O = E = ja, isNaN(
            ua) && !this.fillToGraph && (N = na));
          if (!Bb && W < ua || Bb && W < Ba) {
            v.isNegative = !0, Ra && (Na = Ra), cb && (Wa = cb), void 0 != Ja && (Ha = Ja);
          }
          Va = !1;
          isNaN(
            W) || (m ? W > Ta ? (Sa && (Va = !0), Sa = !1) : (Sa || (Va = !0), Sa = !0) : v.isNegative = W < Pa ? !0 : !1, Ba = W);
          var Pb = !1;
          ...
          switch (h) {
            case'line':
              if (isNaN(W)) {
                ...
                if (Va || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched || !isNaN(
                    v.dashLength)) {
                  this.drawLineGraph(x, u, T, U), x = [ E ], u = [ F ], T = [], U = [], !Ma || isNaN(N) || isNaN(
                    O) || (T.push(O), U.push(
                    N)), m ? (Sa ? (this.lineColorSwitched = xa, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Ra), void 0 === this.bulletColor && (this.bulletColorSwitched = xa)) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, void 0 === this.bulletColor && (this.bulletColorSwitched = this.lineColorSwitched)), this.dashLengthSwitched = v.dashLength;
                }
            ...
            case'smoothedLine':
              if (isNaN(W)) {
                ...
                if (Va || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched || !isNaN(
                    v.dashLength)) {
                  this.drawSmoothedGraph(x, u, T, U), x = [ E ], u = [ F ], T = [], U = [], !Ma || isNaN(N) || isNaN(
                    O) || (T.push(O), U.push(
                    N)), this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched = v.dashLength;
                }
            ...
            case'step':
              if (!isNaN(W)) {
                t ? (isNaN(A) || (x.push(A), u.push(F - wa)), u.push(F - wa), x.push(E), u.push(F + Ga), x.push(
                  E), !Ma || isNaN(N) || isNaN(O) || (isNaN(B) || (T.push(B), U.push(N - wa)), T.push(
                  O), U.push(N - wa), T.push(O), U.push(N + Ga))) : (isNaN(y) || (u.push(
                  y), x.push(E - wa)), x.push(E - wa), u.push(F), x.push(E + Ga), u.push(F), !Ma || isNaN(N) || isNaN(
                  O) || (isNaN(D) || (T.push(O - wa), U.push(D)), T.push(O - wa), U.push(N), T.push(O + Ga), U.push(
                  N)));
                A = E;
                y = F;
                B = O;
              ...
              if (!isNaN(W)) {
                ...
                if (!(W < Qb && rb < Qb || W > Rb && rb > Rb)) {
                  ...
                  if (t) {
                    ...
                    isNaN(
                      G.percentWidthValue) || (K = this.height * G.percentWidthValue / 100, R = ja - K / 2, Ea = R + K / 2);
                    K = d.roundTo(K, 2);
                    ba = d.roundTo(ba, 2);
                    R < q && 0 < K && (va = new d.Cuboid(g, ba, K, H - a.d3x, Q - a.d3y, Na, Wa, da, Ca, X, ga, w, t,
                      ea, gb, pb, aa), v.columnWidth = Math.abs(ba), v.columnHeight = Math.abs(K));
                  } else {
                    ...
                    isNaN(
                      G.percentWidthValue) || (K = this.width * G.percentWidthValue / 100, S = ja - K / 2, ya = S + K / 2);
                    K = d.roundTo(K, 2);
                    ba = d.roundTo(ba, 2);
                    S < n + Z * H && 0 < K && (this.showOnAxis && (R -= Q / 2), va = new d.Cuboid(g, K,
                      ba, H - a.d3x, Q - a.d3y, Na, Wa, da, Ca, this.lineAlpha, ga, w, t, ea, gb, pb,
                      aa), v.columnHeight = Math.abs(ba), v.columnWidth = Math.abs(K));
                  }
                }
                if (va) {
                  za = va.set;
              ...
              if (!isNaN(ua) && !isNaN(W)) {
                ...
                if (t) {
                  ...
                  if (R < q && 0 < K) {
                    ...
                    !isNaN(sa) && !isNaN(qa) && F < q && 0 < F && (Ya = d.line(g, Eb, [ F, F ], Ca, X, da), hb = d.line(
                      g, Fb, [ F, F ], Ca, X, da));
                    ba = E - O;
                  ...
                  if (S < n && 0 < K) {
                    ...
                    !isNaN(ta) && !isNaN(ra) && E < n && 0 < E && (Ya = d.line(g, [ E, E ], Gb, Ca, X, da), hb = d.line(
                      g, [ E, E ], Hb, Ca, X, da), d.setCN(a, Ya, this.bcn + 'line-high'), v.className && d.setCN(a, Ya,
                      v.className, !0), d.setCN(a, hb, this.bcn + 'line-low'), v.className && d.setCN(a, hb,
                      v.className, !0));
                  }
                }
                va && (za = va.set, v.columnGraphics = za, fa.push(za), za.translate(
                  S, R - da / 2), (v.url || this.showHandOnHover) && za.setAttr('cursor', 'pointer'), Ya && (fa.push(
                  Ya), fa.push(hb)), J || (v.x = t ? R + K / 2 : S + K / 2, this.animateColumns(va, L, E, O, F,
                  N), this.addListeners(za, v), void 0 !== this.tabIndex && za.setAttr('tabindex', this.tabIndex)));
              }
              break;
            case'ohlc':
              if (!(isNaN(ua) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                ...
                if (t) {
                  ...
                  var Ib = F - k / 2, Ib = d.fitToBounds(Ib, 0, q), Tb = d.fitToBounds(F, 0, q), Jb = F + k / 2,
                  ...
                  'high' == l && (la = ta);
                  'low' == l && (la = ra);
                  var ka = E, ra = d.fitToBounds(ra, 0, Fa), ta = d.fitToBounds(ta, 0, Fa), Kb = E - k / 2,
                    Kb = d.fitToBounds(Kb, 0, n), Ub = d.fitToBounds(E, 0, n), Lb = E + k / 2,
            ...
            if (this.end - this.start <= Vb || 0 === Vb) {
              ...
              if ('regular' == M || '100%' == M) {
                ...
                if (Zb) {
                  ...
                  if (Oa) {
                    var $b = Oa.getBBox(), ac = $b.width, bc = $b.height, ib, jb, sb = f.totalTextOffset,
                      cc = f.totals[ L ];
                    cc && cc.remove();
                    var kb = 0;
      ...
      this.lastDataItem = v;
      if ('line' == h || 'step' == h || 'smoothedLine' == h) {
        'smoothedLine' == h ? this.drawSmoothedGraph(x, u, T, U) : this.drawLineGraph(x, u, T,
          U), J || this.launchAnimation();
      }
      ...
      0 < e && !c.animationPlayed && (c.seqAn ? (a.set.hide(), c.animationArray.push(a), e = setTimeout(function () {
        c.animate.call(c);
      }, e / (c.end - c.start + 1) * (b - c.start) * 1E3), c.timeOuts.push(e)) : c.animate(a), c.chart.animatable.push(
        a));
      ...
      f && (b = f(a, b));
      if (void 0 !== b && '' !== b) {
        return a = d.text(this.container, b, g, e.fontFamily, c), a.node.style.pointerEvents = 'none', d.setCN(e,
      ...
      if (1 < a.length) {
        ...
        0 !== g.negativeBase && (y = g.valueAxis.getCoordinate(g.negativeBase,
          f), y > g.height && (y = g.height), 0 > y && (y = 0));
        ...
        void 0 === z || g.useNegativeColorIfDown || (p = d.line(l, a, b, z, r, p, x, !1, !1, f), p.node.setAttribute(
          'stroke-linejoin', 'round'), d.setCN(k, p, g.bcn + 'stroke'), d.setCN(k,
          p, g.bcn + 'stroke-negative'), n.push(p));
        if (0 < h || 0 < A) {
          if (p = a.join(';').split(';'), r = b.join(';').split(
              ';'), q = k.type, 'serial' == q || 'radar' == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(
              c), r = b.concat(e)) : 'radar' == q ? (r.push(0), p.push(0)) : g.rotate ? (r.push(
              r[ r.length - 1 ]), p.push(y), r.push(r[ 0 ]), p.push(y), r.push(r[ 0 ]), p.push(p[ 0 ])) : (p.push(
              p[ p.length - 1 ]), r.push(y), p.push(p[ 0 ]), r.push(y), p.push(a[ 0 ]), r.push(
              r[ 0 ])) : 'xy' == q && (b = g.fillToAxis) && (d.isString(b) && (b = k.getValueAxisById(
              b)), 'H' == b.orientation ? (y = 'top' == b.position ? 0 : b.height, p.push(p[ p.length - 1 ]), r.push(
              y), p.push(p[ 0 ]), r.push(y), p.push(a[ 0 ]), r.push(
              r[ 0 ])) : (y = 'left' == b.position ? 0 : b.width, r.push(r[ r.length - 1 ]), p.push(y), r.push(
              r[ 0 ]), p.push(y), r.push(r[ 0 ]), p.push(p[ 0 ]))), a = g.gradientRotation, 0 < h && (b = d.polygon(l,
              p, r, w, h, 1, '#000', 0, a, f), b.pattern(g.pattern, NaN, k.path), d.setCN(k, b, g.bcn + 'fill'), m.push(
              b)), u || void 0 !== z) {
            isNaN(A) && (A = h), u || (u = z), f = d.polygon(l, p, r, u, A, 1, '#000', 0, a, f), d.setCN(k,
              f, g.bcn + 'fill'), d.setCN(k, f, g.bcn + 'fill-negative'), f.pattern(g.pattern, NaN, k.path), n.push(
              f), n.click(function (a) {
              g.handleGraphEvent(a, 'clickGraph');
            }).mouseover(function (a) {
              g.handleGraphEvent(a, 'rollOverGraph');
            }).mouseout(function (a) {
      ...
      if (1 < a.length) {
        ...
        g.push(l);
        g.push(k);
        var m = this.lineAlpha, n = this.lineThickness, g = this.dashLength, q = this.fillAlphas, p = this.lineColorR,
          t = this.fillColorsR, r = this.negativeLineColor, w = this.negativeFillColors, z = this.negativeFillAlphas,
          x = this.baseCoord, u = this.lineColorSwitched;
        u && (p = u);
        ...
        k.push(m.path);
        void 0 !== r && (n = new d.Bezier(h, a, b, r, A, n, t, 0, g, void 0, u), d.setCN(f,
          n, this.bcn + 'stroke'), d.setCN(f, n, this.bcn + 'stroke-negative'), l.push(n.path));
        0 < q && (n = a.join(';').split(';'), m = b.join(';').split(';'), p = '', 0 < c.length ? (c.push('M'), e.push(
          'M'), c.reverse(), e.reverse(), n = a.concat(c), m = b.concat(
          e)) : (this.rotate ? (p += ' L' + x + ',' + b[ b.length - 1 ], p += ' L' + x + ',' + b[ 0 ]) : (p += ' L' + a[ a.length - 1 ] + ',' + x, p += ' L' + a[ 0 ] + ',' + x), p += ' L' + a[ 0 ] + ',' + b[ 0 ]), a = new d.Bezier(
          h, n, m, NaN, 0, 0, t, q, g, p, u), d.setCN(f, a, this.bcn + 'fill'), a.path.pattern(this.pattern, NaN,
          f.path), k.push(a.path), w || void 0 !== r) && (z || (z = q), w || (w = r), h = new d.Bezier(h, n, m, NaN, 0,
          0, w, z, g, p, u), h.path.pattern(this.pattern, NaN, f.path), d.setCN(f, h, this.bcn + 'fill'), d.setCN(f,
          h, this.bcn + 'fill-negative'), l.push(h.path));
        this.applyMask(l, k);
      }
      ...
      b && (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3), c.translate(e,
        -1E3)), b.animate({ opacity: 1, translate: e + ',' + d }, f, h), c.animate(
        { opacity: 1, translate: e + ',' + d }, f, h), a.animatable.push(b));
    }, animate: function (a) {
      ...
      if (!isNaN(b) && !isNaN(c) && ('none' != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
        ...
        l && (p && p.remove(), 'function' == typeof l ? (l = new l, l.chart = e, a.bulletConfig && (l.availableSpace = c, l.graph = this, l.graphDataItem = a, l.bulletY = c, a.bulletConfig.minCoord = this.minCoord - c, l.bulletConfig = a.bulletConfig), l.write(
          g), p && l.showBullet && l.set.push(
          p), a.customBulletGraphics = l.cset, p = l.set) : (p = g.set(), l = g.image(l, 0, 0, h, h), p.push(
          l), this.centerCustomBullets && l.translate(-h / 2, -h / 2)));
        if (p) {
        ...
        if (p) {
          ...
          if (e = this.bulletHitAreaSize) {
            g = d.circle(g, e, '#FFFFFF', .001, 0), g.translate(b, c), a.hitBullet = g, this.bulletSet.push(
              g), this.addListeners(g, a);
          }
          a.bulletGraphics = p;
      ...
      if (a) {
        ...
        var e = {
          type: 'rollOverGraphItem', item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b
        };
        this.fire(e);
        c.fire(e);
      ...
      if (a) {
        var c = {
          type: 'rightClickGraphItem', item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b
        };
        this.fire(c);
        this.chart.fire(c);
      }
      ...
      if (a) {
        var c = {
          type: 'doubleClickGraphItem', item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b
        };
        this.fire(c);
        this.chart.fire(c);
      }
      ...
      if (a) {
        ...
        if (h && h.enabled && this.showBalloon && !this.hidden) {
          ...
          m && '' !== m ? (e = f.getBalloonColor(this,
            a), h.drop || (h.pointerOrientation = b), b = a.x, g = a.y, f.rotate && (b = a.y, g = a.x), b += k, g += l, isNaN(
            b) || isNaN(g) ? this.hideBalloonReal() : (a = this.width, q = this.height, n && h.setBounds(k,
            l, a + k, q + l), h.changeColor(e), h.setPosition(b,
            g), h.fixPrevious(), h.fixedPosition && (c = !1), !c && 'radar' != f.type && (b < k - .5 || b > a + k || g < l - .5 || g > q + l) ? (h.showBalloon(
            m), h.hide(0)) : (h.followCursor(c), h.showBalloon(
            m)))) : (this.hideBalloonReal(), h.hide(), this.resizeBullet(a, e, g));
        } else {
          this.hideBalloonReal();
        }
      }
      ...
      if (a && d.isModern && (1 != b || !isNaN(c))) {
        ...
        e && !e.doNotScale && (e.translate(a.bx, a.by, b), isNaN(c) || (e.setAttr('fill-opacity', c), e.setAttr(
          'stroke-opacity', c)), this.resizedDItem = a);
      }
    }
  });
})();
(function () {
  ...
  d.ChartCursor = d.Class({
    construct: function (a) {
      ...
      this.createEvents('changed', 'zoomed', 'onHideCursor', 'onShowCursor', 'draw', 'selected', 'moved', 'panning',
        'zoomStarted');
      this.enabled = !0;
      this.cursorAlpha = 1;
      ...
      a.cursorSet.push(b);
      this.createElements();
      d.isString(this.limitToGraph) && (this.limitToGraph = d.getObjById(a.graphs,
        this.limitToGraph), this.fullWidth = !1, this.cursorPosition = 'middle');
      ...
      if (c) {
        var e = c.chartData;
        e && (isNaN(
          b) && (b = e.length - 1), 37 != a.keyCode && 40 != a.keyCode || b--, 39 != a.keyCode && 38 != a.keyCode || b++, b = d.fitToBounds(
          b, c.startIndex, c.endIndex), (a = this.chart.chartData[ b ]) && this.setPosition(
          a.x.categoryAxis), this.prevIndex = b);
      }
    }, update: function () {
      var a = this.chart;
      if (a) {
        ...
        if (a.chartData && 0 < a.chartData.length) {
          this.mouseIsOver() ? (this.hideGraphBalloons = !1, this.rolledOver = e = !0, this.updateDrawing(), this.vvLine && isNaN(
            this.fx) && (a.rotate || !this.limitToGraph) && this.vvLine.translate(b, 0), !this.hhLine || !isNaN(
            this.fy) || a.rotate && this.limitToGraph || this.hhLine.translate(0, c), isNaN(
            this.mouse2X) ? this.dispatchMovedEvent(b, c) : e = !1) : this.forceShow || this.hideCursor();
          if (this.zooming) {
      ...
      if (this.drawingNow && (d.remove(
          this.drawingLine), 1 < Math.abs(this.drawStartX - this.mouseX) || 1 < Math.abs(this.drawStartY - this.mouseY))) {
        var a = this.chart, b = a.marginTop, a = a.marginLeft;
        this.drawingLine = d.line(this.container, [ this.drawStartX + a, this.mouseX + a ],
          [ this.drawStartY + b, this.mouseY + b ], this.cursorColor, 1, 1);
      }
    }, fixWidth: function (a) {
      if (this.fullWidth && this.prevLineWidth != a) {
        ...
        b.translate(c, 0);
        c = d.rect(this.container, a, this.height, this.cursorColor, this.cursorAlpha, this.cursorAlpha,
          this.cursorColor);
      ...
      if (!isNaN(a)) {
        ...
        this.prevLineX != a && (c = this.animationDuration, this.zooming && (c = 0), this.vvLine.stop(), this.vvLine.animate(
          { translate: a + ',' + b }, c, 'easeOutSine'), this.prevLineX = a, this.prevLineY = b);
      }
      ...
      if (!isNaN(a)) {
        ...
        this.prevLineY != a && (c = this.animationDuration, this.zooming && (c = 0), this.hhLine.stop(), this.hhLine.animate(
          { translate: b + ',' + a }, c, 'easeOutSine'), this.prevLineY = a, this.prevLineX = b);
      }
      ...
      this.chart.wasTouched && this.leaveAfterTouch || this.isHidden || this.leaveCursor || (this.hideCursorReal(), a ? this.chart.handleCursorHide() : this.fire(
        { target: this, chart: this.chart, type: 'onHideCursor' }), this.chart.setMouseCursor('auto'));
      ...
      !this.drawing && this.enabled && (this.vLineEnabled && this.vvLine && this.vvLine.show(), this.hLineEnabled && this.hhLine && this.hhLine.show(), this.isHidden = !1, this.updateFullLine(), a || this.fire(
        { target: this, chart: this.chart, type: 'onShowCursor' }), this.pan && this.chart.setMouseCursor('move'));
      ...
      if (!this.pan && this.enabled) {
        ...
        isNaN(this.mouse2X) && 0 < Math.abs(g) && 0 < Math.abs(f) && (a = this.chart, b = d.rect(this.container, g, f,
          this.cursorColor, this.selectionAlpha), d.setCN(a, b,
          'cursor-selection'), b.width = g, b.height = f, b.translate(c, e), this.set.push(b), this.selection = b);
        this.updateFullLine();
      }
      ...
      if (this.mouseIsOver()) {
        ...
        } else if (this.dispatchMovedEvent(this.mouseX, this.mouseY), !this.pan && isNaN(this.mouse2X0) && (isNaN(
            this.fx) || (this.mouseX0 = this.fx), isNaN(
            this.fy) || (this.mouseY0 = this.fy)), this.hZoomEnabled || this.vZoomEnabled) {
          this.zooming = !0;
      ...
      if (this.drawingNow) {
        ...
        (2 < Math.abs(a - c) || 2 < Math.abs(b - e)) && this.fire(
          { type: 'draw', target: this, chart: g, initialX: a, initialY: b, finalX: c, finalY: e });
      }
      this.zooming && (this.zooming = !1, this.selectWithoutZooming ? this.dispatchZoomEvent(
        'selected') : (this.hZoomEnabled || this.vZoomEnabled) && this.dispatchZoomEvent(
        'zoomed'), this.rolledOver && this.dispatchMovedEvent(this.mouseX, this.mouseY));
      ...
      if (!this.pan) {
        ...
        if (b && 3 < Math.abs(b.width) && 3 < Math.abs(b.height)) {
          ...
          l && l.parseDates && !l.equalSpacing && (d = k[ c ] ? k[ c ].time : Math.min(this.timestamp0,
            this.timestamp), f = k[ e ] ? h.getEndTime(k[ e ].time) : Math.max(this.timestamp0, this.timestamp));
          var b = {
            type: a,
            chart: this.chart,
            target: this,
      ...
      if (this.mouseIsDown) {
        ...
        isNaN(c) || isNaN(e) || (0 !== Math.abs(c) && 0 !== Math.abs(
          e) && (g = !0), this.prevDelta2X != c && this.prevDelta2Y != e) || (g = !1);
      ...
      a != this.index && (this.index = a, b || this.isHidden || this.dispatchMovedEvent(this.mouseX, this.mouseY,
        'changed'));
    }, handleMouseOut: function () {
      this.enabled && this.rolledOver && (this.leaveCursor || this.setIndex(
        void 0), this.forceShow = !1, this.hideCursor(), this.rolledOver = !1);
      ...
      this.rotate ? (d = NaN, this.vvLine && this.vvLine.hide(), this.hhLine && e && (isNaN(
        a.fy) ? this.hhLine.translate(0, a.mouseY) : this.fixHLine(a.fy,
        0))) : (f = NaN, this.hhLine && this.hhLine.hide(), this.vvLine && c && (isNaN(a.fx) ? this.vvLine.translate(
        a.mouseX, 0) : this.fixVLine(a.fx, 0)));
  ...
  d.SimpleChartScrollbar = d.Class({
    construct: function (a) {
      ...
      if (!isNaN(a) && !isNaN(b)) {
        ...
        this.rotate ? (e = 0, d = a, f = this.width + 1, h = b - a, c.setAttr('height', b - a), c.setAttr('y',
          d)) : (e = a, d = 0, f = b - a, h = this.height + 1, k = b - a, c.setAttr('x', e), c.setAttr('width', k));
      ...
      if (k) {
        c = k.x + d;
        e = k.y + f;
        var l = k.width, k = k.height, m = this.rotate, n = this.chart, q = this.width, p = this.height, t = n.mouseX,
          n = n.mouseY;
        a = this.initialMouse;
        ...
        if (this.resizingRight) {
          if (m) {
            if (a = n - e, !isNaN(
                this.maxHeight) && a > this.maxHeight && (a = this.maxHeight), a + e > p + f && (a = p - e + f), 0 > a) {
              ...
              this.maxWidth) && a > this.maxWidth && (a = this.maxWidth), a + c > q + d && (a = q - c + d), 0 > a) {
            this.resizingRight = !1, b = this.resizingLeft = !0;
          } else {
            if (0 === a || isNaN(a)) {
              a = .1;
        ...
        if (this.resizingLeft) {
          if (m) {
            if (c = e, e = n, e < f && (e = f), isNaN(
                e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, !isNaN(
                this.maxHeight) && a > this.maxHeight && (a = this.maxHeight, e = c), 0 > a) {
          ...
          } else if (e = t, e < d && (e = d), isNaN(
              e) && (e = d), e > q + d && (e = q + d), a = !0 === b ? c - e : l + c - e, !isNaN(
              this.maxWidth) && a > this.maxWidth && (a = this.maxWidth, e = c), 0 > a) {
      ...
      if (this.skipEvent) {
        ...
        if (this.percentStart != this.prevPercentStart || this.percentEnd != this.prevPercentEnd || this.prevMultiplier != d) {
          this.fire(
            a), this.prevPercentStart = this.percentStart, this.prevPercentEnd = this.percentEnd, this.prevMultiplier = d;
        }
      }
      ...
      this.resizingLeft && (this.resizingLeft = !1, this.mouseIsOver || this.removeCursors(), this.updateOnRelease(), this.fireZoomEvent(
        'zoomEnded'));
      ...
      this.resizingRight && (this.resizingRight = !1, this.mouseIsOver || this.removeCursors(), this.updateOnRelease(), this.fireZoomEvent(
        'zoomEnded'));
      this.updateGripCursor(!1);
    }, iconRollOut: function () {
      this.removeCursors();
    }, iconRollOver: function () {
      this.rotate ? this.vResizeCursor && this.chart.setMouseCursor(
        this.vResizeCursor) : this.hResizeCursor && this.chart.setMouseCursor(this.hResizeCursor);
      this.handleMouseOver();
    }, getDBox: function () {
      if (this.dragger) {
      ...
      if (!a.resizingRight && !a.resizingLeft) {
        ...
        m ? (b = 'y', c = c.mouseY - f / 2 - k, c = d.fitToBounds(c,
          0, a.height - f)) : (b = 'x', c = c.mouseX - h / 2 - l, c = d.fitToBounds(c, 0, a.width - h));
        a.updateOnReleaseOnly ? (a.skipEvent = !1, g.setAttr(b,
          c), a.dispatchScrollbarEvent(), a.clipDragger()) : (a.animating = !0, c = Math.round(c), m ? g.animate(
          { y: c }, e, '>') : g.animate({ x: c }, e, '>'), a.forceClip = !0, clearTimeout(
          a.forceTO), a.forceTO = setTimeout(function () {
  ...
  d.ChartScrollbar = d.Class({
    inherits: d.SimpleChartScrollbar, construct: function (a) {
      ...
      if (a.enabled) {
        ...
        var b = a.chart, c = b.chartData, e = a.categoryAxis, g = a.rotate, f = a.x, h = a.y, k = a.width, l = a.height,
          m = a.gridAxis, n = a.set;
        e.setOrientation(!g);
      ...
      if (this.categoryAxis && 'ValueAxis' == this.categoryAxis.cname) {
        ...
        if (k.parseDates && !k.equalSpacing) {
          if (a = h.lastTime, h = h.firstTime, k = Math.round(b / l) + h, b = this.dragging ? k + this.timeDifference : Math.round((b + c) / l) + h, k > b && (k = b), 0 < g && b - k < g && (b = Math.round(k + (b - k) / 2), m = Math.round(g / 2), k = b - m, b += m, m = !0), 0 < e && b - k > e && (b = Math.round(k + (b - k) / 2), m = Math.round(e / 2), k = b - m, b += m, m = !0), b > a && (b = a), b - g < k && (k = b - g), k < h && (k = h), k + g > b && (b = k + g), k != this.startTime || b != this.endTime) {
            this.startTime = k, this.endTime = b, f.start = k, f.end = b, f.startDate = new Date(
              k), f.endDate = new Date(b), this.fire(f);
          }
        } else {
          k.startOnAxis || (b += l / 2);
          c -= this.stepWidth / 2;
          ...
          if (g != this.start || this.end != b) {
            k.startOnAxis && (this.resizingRight && g == b && b++, this.resizingLeft && g == b && (0 < g ? g-- : b = 1)), this.start = g, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start, f.end = this.end, k.parseDates && (a[ this.start ] && (f.startDate = new Date(
              a[ this.start ].time)), a[ this.end ] && (f.endDate = new Date(a[ this.end ].time))), this.fire(f);
          }
          this.percentStart = g;
          this.percentEnd = b;
        }
  ...
  d.AmBalloon = d.Class({
    construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        f.node.style.pointerEvents = 'none';
        this.set = f;
        this.mainSet ? (this.mainSet.push(
          this.set), this.sdx = this.mainSet.x, this.sdy = this.mainSet.y) : c.balloonsSet.push(f);
        if (this.show) {
          ...
          var r = this.horizontalPadding, w = this.verticalPadding, z = this.pointerWidth, x = this.pointerOrientation,
            u = this.cornerRadius, A = c.fontFamily, y = this.fontSize;
          ...
          this.drop ? (h = C / 1.6, l = 0, 'V' == x && (x = 'down'), 'H' == x && (x = 'left'), 'down' == x && (D = a + 1, y = b - h - h / 3), 'up' == x && (l = 180, D = a + 1, y = b + h + h / 3), 'left' == x && (l = 270, D = a + h + h / 3 + 2, y = b), 'right' == x && (l = 90, D = a - h - h / 3 + 2, y = b), k = y - H / 2 + 1, m = D - I / 2 - 1, q = d.drop(
            g, h, l, q, w, r, p, aa)) : 0 < u || 0 === z ? (0 < M && (a = d.rect(g, C, A, q, 0, r + 1, P, M,
            u), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(g, C, A, q, w, r, p, aa,
            u)) : (t = [], u = [], 'H' != x ? (h = a - D, h > C - z && (h = C - z), h < z && (h = z), t = [
            0, h - z, a - D, h + z, C, C, 0, 0
          ], u = Q ? [ 0, 0, b - y, 0, 0, A, A, 0 ] : [
            A, A, b - y, A, A, 0, 0, A
          ]) : (x = b - y, x > A - z && (x = A - z), x < z && (x = z), u = [
            0, x - z, b - y, x + z, A, A, 0, 0
          ], t = a < h + (l - h) / 2 ? [ 0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0 ] : [
            C, C, D + C > a ? C : a - D, C, C, 0, 0, C
          ]), 0 < M && (a = d.polygon(g, t, u, q, 0, r, P, M), a.translate(1, 1), f.push(a)), q = d.polygon(g, t, u, q,
            w, r, p, aa));
          this.bg = q;
          f.push(q);
          q.toFront();
          ...
          0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN,
            !0), f.animate({ translate: D - g + ',' + y }, b,
            'easeOutSine'), n && (B.left = this.prevTX + 'px', B.top = this.prevTY + 'px', this.xAnim = c.animate(
            { node: n }, 'left', this.prevTX, m, b, 'easeOutSine', 'px'), this.yAnim = c.animate({ node: n }, 'top',
            this.prevTY, k, b, 'easeOutSine', 'px')));
          this.prevX = D - g;
          this.prevY = y;
          this.prevTX = m;
          this.prevTY = k;
      ...
      if (this.text != a || this.positionChanged) {
        this.text = a, this.isHiding = !1, this.show = !0, this.destroyTO && clearTimeout(
          this.destroyTO), a = this.chart, this.fadeAnim1 && a.stopAnim(this.fadeAnim1), this.fadeAnim2 && a.stopAnim(
          this.fadeAnim2), this.draw(), this.positionChanged = !1;
      }
    }, hide: function (a) {
      var b = this;
      b.text = void 0;
      ...
      !isNaN(
        c) && a && (b.pointToX = c - b.offsetX * b.deltaSignX, b.pointToY = d, b.followMouse(), b.interval = setInterval(
        function () {
  ...
  d.AmCoordinateChart = d.Class({
    inherits: d.AmChart, construct: function (a) {
      ...
      for (u = b; u < c; u++) {
        ...
        q && (B.labelColor = D[ q ]);
        x[ D[ h ] ] = B;
        if (k && (m.categoryFunction ? b = m.categoryFunction(b, D,
            m) : (!A || b instanceof Date || (b = b.toString() + ' |'), b = d.getDate(b, A,
            m.minPeriod)), b = d.resetDateToMin(b, r, t, m.firstDayOfWeek), B.category = b, B.time = b.getTime(), isNaN(
            B.time))) {
          continue;
        }
      ...
      for (var h = 'value error open close low high'.split(' '), k = 0; k < h.length; k++) {
        ...
        var m = a[ b[ l + 'Field' ] + c ];
        null !== m && (g = Number(m), isNaN(
          g) || (e[ l ] = g), 'date' == b.valueAxis.type && void 0 !== m && (g = d.getDate(m,
          b.chart.dataDateFormat), e[ l ] = g.getTime()));
      }
      return e;
      ...
      for (d = 0; d < b.length; d++) {
        ...
        f && (h = f.axes[ h ].graphs[ a.id ], h.serialDataItem = f, h.values = this.processValues(g, a,
          a.periodValue), this.processFields(a, h, g));
      }
      ...
      if (a) {
        for (var c = 0; c < a.length; c++) {
          ...
          var g = e.valueAxis;
          g ? (d.isString(g) && (g = this.getValueAxisById(g)), g ? g.addGuide(e) : this.valueAxes[ 0 ].addGuide(
            e)) : isNaN(e.value) || this.valueAxes[ 0 ].addGuide(e);
        }
      }
      ...
      g.duration && b.values.value && (g = d.formatDuration(b.values.value, g.duration, '', g.durationUnits,
        g.maxInterval, g.numberFormatter), a = a.split('[[value]]').join(g));
  ...
  d.TrendLine = d.Class({
    construct: function (a) {
      ...
      var b = a.chart, c = b.container, e, g, f, h, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory,
        n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, w = a.finalXValue,
        z = a.initialValue, x = a.finalValue, u = p.recalculateToPercents, A = b.dataDateFormat;
      k && (l && (l = d.getDate(l, A, 'fff'), a.initialDate = l, e = k.dateToCoordinate(
        l)), m && (e = k.categoryToCoordinate(m)), n && (n = d.getDate(n, A,
        'fff'), a.finalDate = n, g = k.dateToCoordinate(n)), q && (g = k.categoryToCoordinate(q)));
      ...
      if (!(isNaN(e) || isNaN(g) || isNaN(f) || isNaN(f))) {
        ...
        a.set = c;
        if (f = a.initialImage) {
          f = d.processObject(f, d.Image,
            a.theme), f.chart = b, f.draw(), f.translate(e[ 0 ] + f.offsetX, g[ 0 ] + f.offsetY), c.push(f.set);
        }
        if (f = a.finalImage) {
          f = d.processObject(f, d.Image,
            a.theme), f.chart = b, f.draw(), f.translate(e[ 1 ] + f.offsetX, g[ 1 ] + f.offsetY), c.push(f.set);
        }
        c.mouseup(function () {
          a.handleLineClick();
        }).mouseover(function () {
      ...
      this.balloonText && (clearTimeout(this.chart.hoverInt), a = this.line.getBBox(), this.chart.showBalloon(
        this.balloonText, this.lineColor, !0, this.x + a.x + a.width / 2, this.y + a.y + a.height / 2));
...
(function () {
  ...
  d.Image = d.Class({
    construct: function (a) {
      ...
      a.set = b.set();
      var c, d;
      a.url ? (c = b.image(a.url, 0, 0, a.width, a.height), d = 1) : a.svgPath && (c = b.path(a.svgPath), c.setAttr(
        'fill', a.color), c.setAttr('stroke',
        a.outlineColor), b = c.getBBox(), d = Math.min(a.width / b.width, a.height / b.height));
      c && (c.setAttr('opacity', a.opacity), a.set.rotate(a.rotation), c.translate(-a.width / 2, -a.height / 2,
        d), a.balloonText && c.mouseover(function () {
...
(function () {
  ...
  d.polygon = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    m && (h = Number);
    k = 'M' + (h(b[ 0 ]) + n) + ',' + (h(c[ 0 ]) + f);
    for (q = 1; q < b.length; q++) m && (b[ q ] = d.roundTo(b[ q ], 5), c[ q ] = d.roundTo(c[ q ], 5)), k += ' L' + (h(
      b[ q ]) + n) + ',' + (h(c[ q ]) + f);
    a = a.path(k + ' Z').attr(g);
  ...
  d.bullet = function (a, b, c, e, g, f, h, k, l, m, n, q, p) {
    ...
    switch (b) {
      ...
      case'yError':
        ...
        break;
      case'xError':
        t = a.set(), t.push(d.line(a, [ -c / 2, c / 2 ], [ 0, 0 ], e, g, f)), t.push(
          d.line(a, [ -c / 2, -c / 2 ], [ -l, l ], e, g, f)), t.push(d.line(a, [ c / 2, c / 2 ], [ -l, l ], e, g, f));
    }
    t && t.pattern(n, NaN, q);
    return t;
  };
  ...
  d.line = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    g = d.dy;
    h = 'M' + (e(b[ 0 ]) + m) + ',' + (e(c[ 0 ]) + g);
    for (k = 1; k < b.length; k++) b[ k ] = d.roundTo(b[ k ], 5), c[ k ] = d.roundTo(c[ k ], 5), h += ' L' + (e(
      b[ k ]) + m) + ',' + (e(c[ k ]) + g);
    if (d.VML) {
  ...
  d.makeHD = function (a, b, c) {
    for (var d = [], g = [], f = 1; f < a.length; f++) for (var h = Number(a[ f - 1 ]), k = Number(b[ f - 1 ]),
      l = Number(a[ f ]), m = Number(b[ f ]),
      n = Math.round(Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - h) / n, m = (m - k) / n,
      q = 0; q <= n; q++) {
  ...
  d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) {
    ...
    for (n = 1; n < b.length; n++) for (var p = [ b[ n - 1 ], b[ n ] ], t = [ c[ n - 1 ], c[ n ] ],
      t = d.makeHD(p, t, a.handDrawScatter), p = t[ 0 ], t = t[ 1 ], r = 1; r < p.length; r++) q.push(
      d.line(a, [ p[ r - 1 ], p[ r ] ], [ t[ r - 1 ], t[ r ] ], e,
        g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
    return q;
  };
  ...
  d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
    ...
    359.94 < x && (x = 359.94);
    g >= x && (g = x);
    var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, y = b + Math.sin(e * u) * f,
      B = c - Math.cos(e * u) * h, D = b + Math.sin((e + g) * u) * f, C = c - Math.cos((e + g) * u) * h,
      I = b + Math.sin((e + g) * u) * k, u = c - Math.cos((e + g) * u) * w,
      H = { fill: d.adjustLuminosity(m.fill, -.2), 'stroke-opacity': 0, 'fill-opacity': m[ 'fill-opacity' ] }, Q = 0;
    180 < Math.abs(g) && (Q = 1);
    e = a.set();
    var M;
    z && (x = r(10 * x), y = r(10 * y), D = r(10 * D), I = r(10 * I), A = r(10 * A), B = r(10 * B), C = r(10 * C), u = r(10 * u), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, h *= 10, k *= 10, w *= 10, 1 > Math.abs(
      g) && 1 >= Math.abs(D - y) && 1 >= Math.abs(C - B) && (M = !0));
    g = '';
    var P;
    ...
    if (0 < l) {
      ...
      P = a.path(' M' + x + ',' + A + ' L' + x + ',' + (A + l) + ' L' + y + ',' + (B + l) + ' L' + y + ',' + B + ' L' + x + ',' + A + ' Z',
        void 0, void 0, '1000,1000').attr(H);
      l = a.path(' M' + D + ',' + C + ' L' + D + ',' + (C + l) + ' L' + I + ',' + (u + l) + ' L' + I + ',' + u + ' L' + D + ',' + C + ' Z',
        void 0, void 0, '1000,1000').attr(H);
      e.push(P);
      e.push(l);
    }
    z ? (M || (g = ' A' + r(b - f) + ',' + r(c - h) + ',' + r(b + f) + ',' + r(c + h) + ',' + r(y) + ',' + r(
      B) + ',' + r(D) + ',' + r(C)), h = ' M' + r(x) + ',' + r(A) + ' L' + r(y) + ',' + r(B) + g + ' L' + r(
      I) + ',' + r(
      u)) : h = ' M' + x + ',' + A + ' L' + y + ',' + B + (' A' + f + ',' + h + ',0,' + Q + ',1,' + D + ',' + C) + ' L' + I + ',' + u;
    0 < k && (z ? M || (h += ' B' + (b - k) + ',' + (c - w) + ',' + (b + k) + ',' + (c + w) + ',' + I + ',' + u + ',' + x + ',' + A) : h += ' A' + k + ',' + w + ',0,' + Q + ',0,' + x + ',' + A);
    a.handDrawn && (k = d.line(a, [ x, y ], [ A, B ], m.stroke, m.thickness * Math.random() * a.handDrawThickness,
      m[ 'stroke-opacity' ]), e.push(k));
    ...
    d.isModern && 'radial' == t && a.grad && (a.grad.setAttribute('gradientUnits',
      'userSpaceOnUse'), a.grad.setAttribute('r', f), a.grad.setAttribute('cx', b), a.grad.setAttribute('cy', c));
    a.pattern(q, NaN, p);
    e.wedge = a;
    e.push(a);
    return e;
  ...
  d.rgb2hex = function (a) {
    return (a = a.match(
      /^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i)) && 4 === a.length ? '#' + ('0' + parseInt(
      a[ 1 ], 10).toString(16)).slice(-2) + ('0' + parseInt(a[ 2 ], 10).toString(16)).slice(-2) + ('0' + parseInt(
      a[ 3 ], 10).toString(16)).slice(-2) : '';
  };
  d.adjustLuminosity = function (a, b) {
    a && -1 != a.indexOf('rgb') && (a = d.rgb2hex(a));
    a = String(a).replace(/[^0-9a-f]/gi, '');
    6 > a.length && (a = String(a[ 0 ]) + String(a[ 0 ]) + String(a[ 1 ]) + String(a[ 1 ]) + String(a[ 2 ]) + String(
      a[ 2 ]));
    b = b || 0;
    var c = '#', e, g;
    for (g = 0; 3 > g; g++) e = parseInt(a.substr(2 * g, 2), 16), e = Math.round(Math.min(Math.max(0, e + e * b), 255))
      .toString(16), c += ('00' + e).substr(e.length);
    return c;
  };
})();
(function () {
  ...
  d.Bezier = d.Class({
    construct: function (a, b, c, e, g, f, h, k, l, m, n) {
      ...
      g = [];
      for (l = 0; l < b.length; l++) isNaN(b[ l ]) || isNaN(c[ l ]) ? (e += this.drawSegment(g, p,
        t), l < b.length - 1 && (e += 'L' + b[ l + 1 ] + ',' + c[ l + 1 ] + ' '), g = []) : g.push(
        { x: Number(b[ l ]), y: Number(c[ l ]) });
      ...
      if (2 < a.length) {
        for (var g = 0; g < a.length - 1; g++) {
          ...
          0 === g ? (f.push({ x: k.x, y: k.y }), f.push({ x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }), f.push(
            { x: m.x, y: m.y })) : g >= a.length - 2 ? (f.push({ x: h.x, y: h.y }), f.push({ x: k.x, y: k.y }), f.push(
            { x: l.x, y: l.y }), f.push({ x: l.x, y: l.y })) : (f.push({ x: h.x, y: h.y }), f.push(
            { x: k.x, y: k.y }), f.push({ x: l.x, y: l.y }), f.push({ x: m.x, y: m.y }));
          h = [];
          k = Math.round;
...
(function () {
  ...
  d.AmDraw = d.Class({
    construct: function (a, b, c, e) {
      ...
      d.hasSVG ? (d.SVG = !0, b = this.createSvgElement('svg'), a.appendChild(b), this.container = b, this.addDefs(
        e), this.R = new d.SVGRenderer(
        this)) : d.isIE && d.VMLRenderer && (d.VML = !0, d.vmlStyleSheet || (document.namespaces.add('amvml',
        'urn:schemas-microsoft-com:vml'), 31 > document.styleSheets.length ? (b = document.createStyleSheet(), b.addRule(
        '.amvml',
        'behavior:url(#default#VML); display:inline-block; antialias:true'), d.vmlStyleSheet = b) : document.styleSheets[ 0 ].addRule(
        '.amvml',
        'behavior:url(#default#VML); display:inline-block; antialias:true')), this.container = a, this.R = new d.VMLRenderer(
        this, e), this.R.disableSelection(a));
      ...
      d.VML && (g = Math.round(100 * g / Math.min(c,
        e)), c += 2 * f, e += 2 * f, k.bw = f, k.node.style.marginLeft = -f, k.node.style.marginTop = -f);
      1 > c && (c = 1);
      1 > e && (e = 1);
      ...
      if (d.hasSVG) {
        ...
        a && (a.addCodeCredits && b.appendChild(
          document.createTextNode('JavaScript chart by amCharts ' + a.version)), a.accessibleDescription && (b.innerHTML = '', b.appendChild(
          document.createTextNode(a.accessibleDescription))), c.appendChild(b), a.defs && (b = this.createSvgElement(
          'defs'), c.appendChild(b), d.parseDefs(a.defs, b), this.defs = b));
      }
    }
  });
})();
(function () {
  ...
  d.AmDObject = d.Class({
    construct: function (a, b) {
      ...
      this.node.addEventListener ? this.node.addEventListener('contextmenu', a, !0) : this.R.addListener(this,
        'contextmenu', a);
      return this;
    }, stop: function () {
    ...
    construct: function (a, b) {
      ...
      if (void 0 !== c) {
        ...
        if ('shape' == f) {
          ...
          'stroke-dasharray' == b && (h = 'solid', 0 < c && 3 > c && (h = 'dot'), 3 <= c && 6 >= c && (h = 'dash'), 6 < c && (h = 'longdash'), e ? f.dashstyle = h : f.setAttribute(
            'dashstyle', h));
      ...
      var f;
      for (f = 0; f < c.length;
        f++) g += Math.round(100 * f / (c.length - 1)) + '% ' + c[ f ], f < c.length - 1 && (g += ',');
      a = a.fill;
      ...
      8 === document.documentMode ? (a.type = 'tile', a.src = b) : (a.setAttribute('type', 'tile'), a.setAttribute(
        'src', b));
    }, update: function () {
    }
  });
...
(function () {
  ...
  d.SVGRenderer = d.Class({
    construct: function (a) {
      ...
      var f = a.node;
      a[ 'an_' + b ] && d.removeFromArray(this.animations, a[ 'an_' + b ]);
      'translate' == b ? (f = (f = f.getAttribute('transform')) ? String(f)
        .substring(10, f.length - 1) : '0,0', f = f.split(', ').join(' '), f = f.split(' ')
        .join(','), 0 === f && (f = '0,0')) : f = Number(f.getAttribute(b));
      ...
      for (a = b.length - 1; 0 <= a; a--) {
        ...
        if (g <= e) {
          ...
          if ('translate' == h) {
            ...
            l = Number(c.from), k = Number(c.to), m = k - l, c = d[ c.effect ](0, g, l, m, e), isNaN(
              c) && (c = k), 0 === m && this.animations.splice(a, 1);
          }
          this.setAttr(f, h, c);
        } else {
          'translate' == h ? (l = c.to.split(','), m = Number(l[ 0 ]), l = Number(l[ 1 ]), f.translate(m,
            l)) : (k = Number(c.to), this.setAttr(f, h, k)), f.animationFinished = !0, this.animations.splice(a, 1);
        }
      }
    }, getBBox: function (a) {
      if (a = a.node) {
      ...
      h && this.D.remove(h);
      var k = f.parentNode;
      k && (f = document.createElementNS(d.SVG_NS, 'clipPath'), h = d.getUniqueId(), f.setAttribute('id',
        h), this.D.rect(b, c, e, g, 0, 0, f), k.appendChild(
        f), b = '#', d.baseHref && !d.isIE && (b = this.removeTarget(window.location.href) + b), this.setAttr(a,
        'clip-path', 'url(' + b + h + ')'), this.clipPathC++, a.clipPath = f);
    }, text: function (a, b, c) {
      ...
      for (e = 0; e < c.length; e++) h = document.createElementNS(d.SVG_NS,
        'stop'), k = 100 * e / (c.length - 1), 0 === e && (k = 0), h.setAttribute('offset', k + '%'), h.setAttribute(
        'stop-color', c[ e ]), b.appendChild(h);
      ...
      b.color && (n = document.createElementNS(d.SVG_NS, 'rect'), n.setAttributeNS(null, 'height', e), n.setAttributeNS(
        null, 'width', l), n.setAttributeNS(null, 'fill', b.color), f.appendChild(n));
...
(function () {
  ...
  d.AmLegend = d.Class({
    construct: function (a) {
      this.enabled = !0;
      this.cname = 'AmLegend';
      this.createEvents('rollOverMarker', 'rollOverItem', 'rollOutMarker', 'rollOutItem', 'showItem', 'hideItem',
        'clickMarker', 'clickLabel');
      ...
      var a = this.chart, b = this.position, c = this.width, e = a.divRealWidth, g = a.divRealHeight, f = this.div,
        h = this.legendData;
      ...
      c = void 0 !== c ? d.toCoordinate(c,
        e) : 'right' != b && 'left' != b ? a.realWidth : 0 < this.ieW ? this.ieW : a.realWidth;
      'outside' == b ? (c = f.offsetWidth, g = f.offsetHeight, f.clientHeight && (c = f.clientWidth, g = f.clientHeight)) : (isNaN(
        c) || (f.style.width = c + 'px'), f.className = 'amChartsLegend ' + a.classNamePrefix + '-legend-div');
      this.divWidth = c;
      (b = this.container) ? (b.container.innerHTML = '', f.appendChild(
        b.container), b.width = c, b.height = g, b.setSize(c, g), b.addDefs(a)) : b = new d.AmDraw(f, c, g, a);
      this.container = b;
      this.lx = 0;
      this.ly = 8;
      g = this.markerSize;
      ...
      this.titleWidth = 0;
      if (g = this.title) {
        g = d.text(this.container, g, this.color, a.fontFamily, this.fontSize, 'start', !0), d.setCN(a, g,
          'legend-title'), g.translate(
          this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = g.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
      }
      ...
      var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop,
        g = this.marginBottom, f = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal,
      ...
      c = d.polygon(this.container, [ 0, n, n, 0 ], [ 0, 0, l, l ], this.backgroundColor, this.backgroundAlpha, 1,
      ...
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        if (e) {
          ...
          if ('line' == e || 'step' == e || 'smoothedLine' == e || 'ohlc' == e) {
            m = q.set(), a.hidden || (f = a.lineColorR, k = a.bulletBorderColorR), t = d.line(q, [ 0, 2 * p ],
              [ p / 2, p / 2 ], f, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, t, 'graph-stroke'), m.push(
              t), a.bullet && (a.hidden || (f = a.bulletColorR), t = d.bullet(q, a.bullet, a.bulletSize, f,
              a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, t,
              'graph-bullet'), t.translate(p + 1, p / 2), m.push(t)), w = 0, t = p, r = p / 3;
          } else {
        ...
        k = b.switchType;
        var x;
        k && 'none' != k && 0 < p && ('x' == k ? (x = b.createX(), x.translate(p / 2, p / 2)) : x = b.createV(), x.dItem = a, !0 !== a.hidden ? 'x' == k ? x.hide() : x.show() : 'x' != k && x.hide(), b.switchable || x.hide(), b.addListeners(
          x, a), a.legendSwitch = x, q.push(x), d.setCN(c, x, 'legend-switch'));
        k = b.color;
        ...
        void 0 !== b.tabIndex && (q.setAttr('tabindex', b.tabIndex), q.setAttr('role', 'menuitem'), q.keyup(
          function (c) {
            13 == c.keyCode && b.clickMarker(a, c);
          }));
        c.accessible && b.accessibleLabel && (l = d.massReplace(b.accessibleLabel,
          { '[[title]]': a.title }), c.makeAccessible(q, l));
        l = b.fontSize;
        m && (p <= l && (p = p / 2 + b.ly - l / 2 + (l + 2 - p) / 2 - r, m.translate(w, p), x && x.translate(x.x,
          p)), a.legendEntryWidth = m.getBBox().width);
        var u;
        f && (f = d.fixBrakes(f), a.legendTextReal = f, u = b.labelWidth, u = isNaN(u) ? d.text(b.container, f, k,
          c.fontFamily, l, 'start') : d.wrappedText(b.container, f, k, c.fontFamily, l, 'start', !1, u, 0), d.setCN(c,
          u, 'legend-label'), u.translate(b.lx + t, b.ly), q.push(
          u), b.labelDx = t, c = u.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
        b.entries[ b.index ] = q;
      ...
      this.textClickEnabled ? a.hidden || this.dispatch('clickLabel', a,
        b) : this.switchable && (!0 === a.hidden ? this.dispatch('showItem', a, b) : this.dispatch('hideItem', a, b));
      ...
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        if (b.valueText && 0 < b.valueWidth) {
          ...
          var k = b.valueText, g = g + b.lx + b.labelDx + b.markerLabelGap + b.valueWidth, l = 'end';
        ...
        c = b.container.rect(a.legendEntryWidth, 0, f, e, 0, 0)
          .attr({ stroke: 'none', fill: '#fff', 'fill-opacity': .005 });
        c.dItem = a;
      ...
      return d.polygon(this.container, [ a / 5, a / 2, a - a / 5, a / 2 ], [ a / 3, a - a / 5, a / 5, a / 1.7 ],
        this.switchColor);
    }, createX: function () {
        ...
        for (c = 0; c < a.length; c++) {
          ...
          if (e) {
            ...
            if (void 0 !== f.type) {
              ...
              k ? (h = this.valueText, f.legendValueText && (h = f.legendValueText), f.legendValueTextR && (h = f.legendValueTextR), h = b.formatString(
                h, k)) : l && b.formatPeriodString && (l = d.massReplace(l,
                { '[[title]]': f.title }), h = b.formatPeriodString(l, f));
            } else {
...
(function () {
  ...
  d.newDate = function (a, b) {
    return b && -1 == b.indexOf('fff') ? new Date(a) : new Date(a.getFullYear(), a.getMonth(), a.getDate(),
  ...
  d.getMaxInterval = function (a, b) {
    var c = d.intervals;
    return a >= c[ b ].contains ? (a = Math.round(a / c[ b ].contains), b = c[ b ].nextInterval, d.getMaxInterval(a,
      b)) : 'ss' == b ? c[ b ].nextInterval : b;
  };
  ...
  d.stringToDate = function (a, b) {
    var c = {}, e = [
      { pattern: 'YYYY', period: 'year' }, { pattern: 'YY', period: 'year' }, { pattern: 'MM', period: 'month' },
      { pattern: 'M', period: 'month' }, { pattern: 'DD', period: 'date' }, { pattern: 'D', period: 'date' },
      { pattern: 'JJ', period: 'hours' }, { pattern: 'J', period: 'hours' }, { pattern: 'HH', period: 'hours' },
      { pattern: 'H', period: 'hours' }, { pattern: 'KK', period: 'hours' }, { pattern: 'K', period: 'hours' },
      { pattern: 'LL', period: 'hours' }, { pattern: 'L', period: 'hours' }, { pattern: 'NN', period: 'minutes' },
      { pattern: 'N', period: 'minutes' }, { pattern: 'SS', period: 'seconds' }, { pattern: 'S', period: 'seconds' },
    ...
    d.useUTC ? (e = new Date, e.setUTCFullYear(c.year, c.month, c.date), e.setUTCHours(c.hours, c.minutes, c.seconds,
      c.milliseconds)) : e = new Date(c.year, c.month, c.date, c.hours, c.minutes, c.seconds, c.milliseconds);
    return e
  };
  d.getFromDateString = function (a, b, c) {
    if (void 0 !== b) {
      return c = c.indexOf(a), b = String(b), b = b.substr(c, a.length), "0" == b.charAt(0) && (b = b.substr(
        1, b.length - 1)), b = Number(b), isNaN(b) && (b = 0), -1 != a.indexOf("M") && b--, b
    }
  };
  d.formatDate = function (a, b, c) {
    ...
    b = b.replace(/J/g, q);
    r = k;
    0 === r && (r = 24, -1 != b.indexOf("H") && (f--, 0 === f && (e = new Date(
      a), e.setDate(e.getDate() - 1), g = e.getMonth(), f = e.getDate(), e = e.getFullYear())));
    a = g + 1;
    9 > g && (a = "0" + a);
    q = f;
    10 > f && (q = "0" + f);
